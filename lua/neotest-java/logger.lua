-- https://github.com/nvim-neotest/neotest/blob/f30bab1faef13d47f3905e065215c96a42d075ad/lua/neotest/logging.lua
...
function Logger.new(filename, opts)
	...
	if log_info and log_info.size > LARGE then
		local warn_msg = string.format("Neotest log is large (%d MB): %s", log_info.size / (1000 * 1000), logger._filename)
...
return Logger.new("neotest-java", { level = vim.log.levels.TRACE })

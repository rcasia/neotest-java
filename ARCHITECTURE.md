...
| [`nvim-lua/plenary.nvim`](https://github.com/nvim-lua/plenary.nvim) | Yes | Directory scanning fallback and job control for launching the debug JVM (`build_tool/launcher.lua`). |

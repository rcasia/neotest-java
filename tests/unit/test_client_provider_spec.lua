...
describe("ClientProvider", function()
	it(
		"returns an initialized jdtls client immediately (fast path)",
		async(function()
	...
	it(
		"caches the client and does not call get_clients again",
		async(function()
			local call_count = 0
			local mock_client = { initialized = true }
	...
	it(
		"preloads a java file and polls until client is ready (slow path)",
		async(function()
			local mock_client = { initialized = true }
